    ...
    public function datatableGroup()
    {
        ...
        if($this->session->userdata('loggin') && $level == "admin"){
          ...
          $results = $this->datatables->select("
                libelle_group
              , ('<div class=\"btn-group btn-group-md\"><a onclick=\"group_ratc(' || fte_group_id || ');\" href=\"#\" data-toggle=\"modal\" class=\"btn btn-info\"><i class=\"fa  fa-plus\"></i> Rattaché catégorie</a></div>') as categorie
              , ('<div class=\"btn-group btn-group-md\"><a onclick=\"group_ratu(' || fte_group_id || ');\" href=\"#\" data-toggle=\"modal\" class=\"btn btn-info\"><i class=\"fa fa-plus\"></i> Rattaché utilisateur</a></div>') as user
              , ('<div class=\"btn-group btn-group-sm\"><a onclick=\"group_modifier(' || fte_group_id || ');\" href=\"#\" data-toggle=\"modal\" class=\"btn btn-inverse\"><i class=\"fa fa-pencil\"></i></a></div>') as modifier
              , ('<div class=\"btn-group btn-group-sm\"><a onclick=\"group_suppr(' || fte_group_id || ');\" href=\"#\" data-toggle=\"modal\" class=\"btn btn-danger\"><i class=\"fa fa-times\"></i></a></div>') as supprimer
              , ('<div class=\"btn-group btn-group-sm\"><a onclick=\"group_detail(' || fte_group_id || ');\" href=\"#\" data-toggle=\"modal\" class=\"btn btn-info\"><i class=\"fa fa-list\"></i></a></div>') as detail
              ")
                      ->where('flag', 1)
                      ->from('fte_access_group');
