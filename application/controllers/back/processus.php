...
class Processus extends CI_Controller
{
    ...
    public function processus()
    {
        ...
        if ($this->session->userdata('loggin') && $level == "admin") {
            ...
            $this->load->view('includes/menu_vertical_tree_processus.php', $data_pcs);
            ...
            foreach ($pcs as $proc_row) {
                ...
                $data_send_pcs['area_html_' . $proc_row_id] = array(
                    ...
                    'config' => array(
                        ...
                        'filebrowserBrowseUrl' => "/ADLP/assets/components/modules/admin/forms/editors/ckeditor/ckfinder/ckfinder.html",
